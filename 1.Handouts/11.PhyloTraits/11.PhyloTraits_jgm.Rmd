...
package.list <- c('ape', 'seqinr', 'phylobase', 'adephylo', 'geiger', 
      ...
      'ggplot2', 'tidyr', 'dplyr', 'phangorn', 'pander','phytools','vegan','cluster','dendextend','phylogram') 
