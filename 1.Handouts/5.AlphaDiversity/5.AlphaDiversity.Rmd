...
Where the $q$ exponent is the order in which the index is dependent on rare species. For $q = 0$, 1 and 2: $^0D=S$ (species richness), $^1D=e^H$ (exponential Shannon entropy),  $^2D=1/D$ (reciprocal of Simpson index).
...
As you see, it does not meet doubling property. Let's calculate Shannon diversity for each richness level and see what is happening: 
...
Hsieh T. et al. 2016. iNEXT: an R package for rarefaction and extrapolation of species diversity (H ill numbers). Methods Ecol Evol 7: 1451–1456.
