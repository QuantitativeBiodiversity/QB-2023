...
We will install the latest version of R (v 4.0.4; "Lost Library Book") using the following instructions:
...
**Mac users please read**:
    ...
    You can download XQuartz v2.8.0 from the following site: http://xquartz.macosforge.org/landing/
