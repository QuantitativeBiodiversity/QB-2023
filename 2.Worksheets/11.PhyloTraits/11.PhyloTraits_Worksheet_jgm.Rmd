...
This will save the PDF output in your '11.PhyloTraits' folder.
...
rm(list = ls())
getwd()
setwd("~/GitHub/QB-2023/2.Worksheets/11.PhyloTraits")
...
***Question 10***: Using a hierarchical clustering algorithm, map similiarity in resource use map onto the phlogeny and answer the following questions:
